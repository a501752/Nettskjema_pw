 ...
 */
test.skip('Klageskjema privat time-out', async ({ page }) => {
    ...
    /** La testen stå og vente i 16 minutter uten at det gjøres noe */
    await page.waitForTimeout(960000); // waits for 16 minutes (16*60 seconds)
